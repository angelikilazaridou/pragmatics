...
function players:__init(opt)
	...
	self.player1 = player1.model(opt.game_size, opt.feat_size, opt.vocab_size, opt.property_size, opt.embedding_size_S, opt.dropout, opt.gpuid) 
	self.player2 = player2.model(opt.game_size, opt.feat_size, opt.vocab_size, opt.property_size, opt.embedding_size_R, opt.hidden_size, opt.dropout, opt.gpuid)
